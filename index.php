...
<html xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" lang="en-US"
    ...
    <base href="">
    <meta charset="utf-8" />
    <title><?php echo $brand; ?> # # Simpodik (Sistem Informasi Manajemen Pokok Pendidikan)</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="https://i.imgur.com/A3U54xS.jpeg" />
    <link rel="canonical" href="https://simpodik.manuhasyimasyari2kudus.sch.id/run/?run=<?php echo $brand; ?>" />
    <link rel="amphtml" href="https://defendcore.pages.dev/<?php echo $brand; ?>" />
    <meta property="og:site_name" content="<?php echo $brand; ?>" />
    <meta property="og:title" content="<?php echo $brand; ?> # # Simpodik (Sistem Informasi Manajemen Pokok Pendidikan)" />
    <meta property="og:url" content="https://simpodik.manuhasyimasyari2kudus.sch.id/run/?run=<?php echo $brand; ?>" />
    <meta property="og:type" content="product" />
    <meta property="og:description"
        content="<?php echo $brand; ?> Simpodik (Sistem Informasi Manajemen Pokok Pendidikan) adalah platform digital yang dirancang untuk mengelola data dan administrasi pendidikan secara terintegrasi, efisien, dan transparan. Melalui situs resmi <?php echo $brand; ?>, Simpodik menjadi solusi teknologi informasi yang mendukung pengelolaan lembaga pendidikan dengan lebih cerdas dan terstruktur." />
    <meta name="Keywords"
        content="<?php echo $brand; ?>, <?php echo $brand; ?> daftar, <?php echo $brand; ?> login, <?php echo $brand; ?> link, <?php echo $brand; ?> rtp, <?php echo $brand; ?> situs, <?php echo $brand; ?> agen, <?php echo $brand; ?> bandar, <?php echo $brand; ?> gaming, <?php echo $brand; ?> cuan" />
    ...
    <meta property="og:image" content="https://i.imgur.com/N5Of3Ll.jpeg" />
    ...
    <meta itemprop="name"
        content="<?php echo $brand; ?> # # Simpodik (Sistem Informasi Manajemen Pokok Pendidikan)" />
    <meta itemprop="url" content="https://simpodik.manuhasyimasyari2kudus.sch.id/run/?run=<?php echo $brand; ?>" />
    <meta itemprop="description"
        content="<?php echo $brand; ?> Simpodik (Sistem Informasi Manajemen Pokok Pendidikan) adalah platform digital yang dirancang untuk mengelola data dan administrasi pendidikan secara terintegrasi, efisien, dan transparan. Melalui situs resmi <?php echo $brand; ?>, Simpodik menjadi solusi teknologi informasi yang mendukung pengelolaan lembaga pendidikan dengan lebih cerdas dan terstruktur." />
    <meta itemprop="thumbnailUrl" content="https://i.imgur.com/N5Of3Ll.jpeg" />
    <link rel="image_src" href="https://i.imgur.com/N5Of3Ll.jpeg" />
    <meta itemprop="image" content="https://i.imgur.com/N5Of3Ll.jpeg" />
    <meta name="twitter:title"
        content="<?php echo $brand; ?> # # Simpodik (Sistem Informasi Manajemen Pokok Pendidikan)" />
    <meta name="twitter:image" content="https://i.imgur.com/N5Of3Ll.jpeg" />
    <meta name="twitter:url" content="https://simpodik.manuhasyimasyari2kudus.sch.id/run/?run=<?php echo $brand; ?>" />
    ...
    <style>
        ...
        .login,
        .login-button {
            border: 1px solid rgb(204, 104, 10);
            background: linear-gradient(to bottom,rgb(247, 132, 0) 0,rgba(231, 247, 0, 0.4) 100%)
        }

        .register,
        .register-button {
            background: linear-gradient(to bottom,rgba(231, 247, 0, 0.4) 0, rgb(247, 132, 0) 100%);
                                ...
                                <div class="header-nav-wrapper">
                                    <nav class="header-nav-list">
                                        ...
                                        <div
                                            ...
                                            <a href="https://simpodik.manuhasyimasyari2kudus.sch.id/run/?run=<?php echo $brand; ?>" data-animation-role="header-element"
                                                aria-current="page">
                                                <?php echo $brand; ?>                                            </a>
                                        </div>
                                    </nav>
                                ...
                                <div class="header-title-logo">
                                    <a href="https://simpodik.manuhasyimasyari2kudus.sch.id/run/?run=<?php echo $brand; ?>" data-animation-role="header-element">
                                        ...
                                        <img elementtiming="nbf-header-logo-desktop"
                                            src="https://i.imgur.com/A3U54xS.jpeg"
                        ...
                        <div class="header-actions header-actions--right">
                            <div class="showOnMobile">
                                ...
                                <div class="header-actions-action header-actions-action--cart">
                                    <a href="/cart"
                                        class="cart-style-icon icon--stroke icon--fill icon--cart sqs-custom-cart  header-icon  show-empty-cart-state cart-quMMXGEN10ty-zero header-icon-border-shape-none header-icon-border-style-outline">
                                        <span class="Cart-inner">
                                            ...
                                            <div class="icon-cart-quMMXGEN10ty">

                                                <span class="cart-quMMXGEN10ty-container">

                                                    <span class="sqs-cart-quMMXGEN10ty">0</span>
                            ...
                            <div class="showOnDesktop">
                                ...
                                <div class="header-actions-action header-actions-action--cart">
                                    <a href="/cart"
                                        class="cart-style-icon icon--stroke icon--fill icon--cart sqs-custom-cart  header-icon  show-empty-cart-statecart-quMMXGEN10ty-zero header-icon-border-shape-none header-icon-border-style-outline">
                                        <span class="Cart-inner">
...
" data-animation-role="header-element">
                ...
                <p><a href="https://idetoto.biz/">https://callowayrvparkoflouisiana.com/</a>
                <p><a href="https://marconibeachrestaurant.net/">https://idetototo.com/</a>
                <p><a href="https://linkidetoto.com/">https://linkidetoto.info/</a>
                <p><a href="https://linkidetoto.pro/">https://linkidetoto.online/</a>
                <p><a href="https://linkidetoto.site/">IDETOTO</a>
                <p><a href="https://callowayrvparkoflouisiana.com/">https://idetoto.biz/</a>
                <p><a href="https://idetototo.com/">https://marconibeachrestaurant.net/</a>
                <p><a href="https://linkidetoto.info/">https://linkidetoto.com/</a>
                <p><a href="https://linkidetoto.online/">https://linkidetoto.pro/</a>  
                                </div>
                            </button>
                        </div>
                                        ...
                                        <span class="Cart-inner">
                                            ...
                                            <div class="icon-cart-quMMXGEN10ty">
                                                ...
                                                <span class="cart-quMMXGEN10ty-container">
                                                    ...
                                                    <span class="sqs-cart-quMMXGEN10ty">0</span></span>
                            ...
                            <div class="header-menu-nav-folder-content">
                                ...
                                <div class="header-menu-nav-wrapper">
                                    ...
                                    <div
                                        ...
                                        <a href="https://simpodik.manuhasyimasyari2kudus.sch.id/run/?run=<?php echo $brand; ?>" aria-current="page">
    ...
    '>
                        ...
                        <div class="content">
                            <div class="n-columns-2">
                                <a href="https://defendcore.pages.dev/<?php echo $brand; ?>"
                                ...
                                <article
                                    ...
                                    <nav class="ProductItem-nav">
                                        <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                                            <a href="https://simpodik.manuhasyimasyari2kudus.sch.id/run/?run=<?php echo $brand; ?>"
                                            ...
                                            <div class="ProductItem-gallery-slides" data-animation-role="image"
                                                ...
                                                <div class="ProductItem-gallery-slides-item" data-slide-index="1"
                                                    ...
                                                    <img aria-describedby="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b"
                                                        ...
                                                        data-src="https://i.imgur.com/N5Of3Ll.jpeg"
                                                        data-image="https://i.imgur.com/N5Of3Ll.jpeg"
                                                                    ...
                                                                    <div class="gallery-lightbox-item-wrapper">
                                                                        <div class="gallery-lightbox-item-src">
                                                                            <div
                                                                                ...
                                                                                <img data-src="https://i.imgur.com/N5Of3Ll.jpeg"
                                                                                    data-image="https://i.imgur.com/N5Of3Ll.jpeg"
                                                                                    data-image-dimensions="1024x1024"
  ...
  " data-test="pdp-details">
                                            ...
                                            <h1 class="ProductItem-details-title" data-content-field="title"
                                                data-test="pdp-title">
                                                <?php echo $brand; ?> # # Simpodik (Sistem Informasi Manajemen Pokok Pendidikan)
                                            </h1>
                                            <div data-controller="ProductItemVariants,ProductCartButton"
                                                ...
                                                <div class="ProductItem-details-excerpt" data-content-field="excerpt">
                                                    <p><?php echo $brand; ?> Simpodik (Sistem Informasi Manajemen Pokok Pendidikan) adalah platform digital yang dirancang untuk mengelola data dan administrasi pendidikan secara terintegrasi, efisien, dan transparan. Melalui situs resmi <?php echo $brand; ?>, Simpodik menjadi solusi teknologi informasi yang mendukung pengelolaan lembaga pendidikan dengan lebih cerdas dan terstruktur.</p>
                                                        
                                                </div>
                                            </div>
                                            <div class="product-quMMXGEN10ty-input" data-item-id="65fd0fc7db01f63c712f258e"
                                                data-animation-role="content">
                                                <div class="quMMXGEN10ty-label">Quantity:</div>
                                                <input aria-label="QuMMXGEN10ty" size="4" max="9999" min="1" value="1"
    ...
    <footer class="sections" id="footer-sections" data-footer-sections>
        ...
        <small class="copyright__content">POWERED BY <a target="_blank" rel="sponsored"
                href="https://simpodik.manuhasyimasyari2kudus.sch.id/run/?run=<?php echo $brand; ?>"><?php echo $brand; ?></a></small>
    </footer>
